 ...
 */
public class AdapterContacts extends ArrayAdapter<String> {


    AdapterContacts(Context context, String [] resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View myView=yogeshInflater.inflate(R.layout.fragment_contacts_adapter,parent,false);
